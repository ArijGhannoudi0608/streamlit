...
from sqlalchemy import text  # Ajout de cette ligne pour utiliser text()
...
with conn.session as s:
    try:
        # Utiliser text() pour déclarer explicitement la chaîne SQL comme une expression textuelle
        s.execute(text('''
